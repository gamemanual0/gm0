...
- `goBILDA Yellow Jacket <https://www.gobilda.com/yellow-jacket-planetary-gear-motors/>`_ has the most varied selection of gearbox ratios with too many to list here, but utilize the rather uncommon bullet connection for power. The output :term:`shaft <Shaft>` is a :term:`6mm D-shaft <Shaft>` or 8 Rex (7mm hex rounded to 8mm round).
