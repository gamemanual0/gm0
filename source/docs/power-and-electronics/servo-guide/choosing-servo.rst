...
Many servos from FTC vendors are Dual Mode, meaning they can switch between continuous and regular modes (often requiring the use of a sold-seperately servo programmer). These servos can be used as either continuous or regular servos.
