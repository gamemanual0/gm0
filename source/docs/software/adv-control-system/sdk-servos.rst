...
ServoImplEx
^^^^^^^^^^^
All REV hub servos are instances of ServoImplEx, which exposes some more methods to the user, such as setting the servp PWM range.
