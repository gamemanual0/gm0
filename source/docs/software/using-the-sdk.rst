...
Using a BulkRead hardware call can help with this problem. A BulkRead takes the same 3ms to execute as any other normal hardware call, but it returns far more data. In order to be able to use BulkReads, you must either be running SDK v5.4 or higher, or use RevExtensions2.
