...
Drivetrain types
==================================
A tank drivetrain primarily utilizes
:term:`traction wheels <Traction wheel>` and cannot strafe (move sideways).
...
due to using either :term:`mecanum <Mecanum Wheel>`
or :term:`omni <Omni Wheel>` wheels.
...
1. **Reliability**: Reliability, the key to success in FIRST Tech Challenge,
   ...
   planetary gearboxes.
   (See the :doc:`../../hardware-basics/motor-guide/index` for details).
...
3. **Number of motors and gear ratio**: Generally, new teams may try
   ...
   cases**. Any gear ratio between 16:1 and 20:1 is perfectly
   reasonable on 4 inch wheels. 19.2:1 on 4 inch wheels is a popular choice
   because it enables one to go 1 to 1 off of a 19.2:1 planetary motor. This
   ratio gives a great balance, having near instant acceleration and a high top
   speed.
   ...
   13.7:1 planetary gearbox motor.
