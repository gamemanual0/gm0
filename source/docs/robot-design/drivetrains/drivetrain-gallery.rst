...
In this section, we compile several sample drivetrains which you can
use as a starting point for your own designs. You should also check
the :doc:`gallery of robot designs <../../appendix/gallery>` in the
Appendix.
