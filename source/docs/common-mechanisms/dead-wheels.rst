...
.. admonition:: Term
   ...
   .. glossary::
      ...
      Odometry wheel
         An odometry wheel is a small unpowered wheel (usually an :term:`omni wheel <Omni Wheel>`) that tracks the distance the robot has traveled through the encoder attached to the wheel's axle.
