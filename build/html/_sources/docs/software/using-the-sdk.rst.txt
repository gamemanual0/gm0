...
Built in to the FTC SDK are many examples of using things such as Color Sensors, 
...
the servo to that position and hold that position. ``setPosition()`` takes 
...
so 0.5 is the middle, 0.75 is ¾ the way up, etc.
