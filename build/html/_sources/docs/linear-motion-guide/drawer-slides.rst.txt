...
**Drawer slides should be mounted oriented vertically, like in an actual drawer. 
...
It allows the REV pulleys used in the Linear Slide Kit to be mounted directly to 
the slide, thus making each stage compact and lightweight. 
