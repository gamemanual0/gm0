...
match, slow acceleration has a significant adverse effect on the competitiveness
of the robot. 
...
.. todo:: link to the drivetrain section where it is mentioned
...
Therefore, it is recommended for teams to refer to the Drivetrain section and 
...
Nearly every competitive robot from past years have used active intakes to great 
effect, so there is plenty of precedent to follow. 
...
This is because arms typically are less effective than linear extensions and are 
harder to implement properly. 
Arms require a high gear ratio, 
which usually in turn will require an expensive gearbox (e.g. VersaPlanetary) 
...
Furthermore, linear slides can have more extension than arms, with some reaching 
over 3-4 feet in length. 
