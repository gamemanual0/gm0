...
This robot could be much more successful if the team spent their time to perfect 
one mechanism first. 
...
We recommend teams focus on one objective during tele-op/endgame and perfect it. 
...
For example, a linear slide goes in and out in a straight line, as opposed to an 
arm, which rotates along an axis. 
...
.. todo:: link to materials guide, wiring section
...
To remedy this problem, refer to the Materials Guide to gain a better 
...
Refer to the Wiring section for more information; in short, make sure to plan 
ahead and leave space for wires, and use strain relief whenever possible. 
...
It is possible to rebuild your robot mid-season, and many top teams have done so 
to great success. 
